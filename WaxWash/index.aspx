...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    <main>
             <img alt="logo" src="Images/Better%20images/Logo%20for%20wax%20wash.jpg" />
       <br />
        ...
        <p>
            <button class="button-something" id="btnBookWash" type="button" onclick="location.href='login.aspx'">Book a Wash</button>
            <button class="button-something" id="btnRegister" type="button" onclick="location.href='register.aspx'">Register</button>
