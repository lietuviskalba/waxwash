...
public class ChangePathHere
{
    ...
    static string bog_PATH = @"Data Source = (LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\Bogdan\Desktop\waxwasz\WaxWash\wax.mdf;Integrated Security = True; Connect Timeout = 30";
